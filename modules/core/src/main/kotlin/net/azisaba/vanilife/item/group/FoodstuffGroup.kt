...
object FoodstuffGroup: ItemGroup {
    override val key: Key = Key.key(Vanilife.PLUGIN_ID, "foodstuff")

    override val icon: ItemStack by lazy { CustomItemTypes.CHEESE.createItemStack() }
