...
object ToolGroup: ItemGroup {
    override val key: Key = Key.key(Vanilife.PLUGIN_ID, "tool")

    override val icon: ItemStack by lazy { CustomItemTypes.KNIFE.createItemStack() }
